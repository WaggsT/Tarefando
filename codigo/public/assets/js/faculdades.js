...
document.addEventListener("DOMContentLoaded", () => {
  // ====== CONFIG ======
  const LOCAL_JSON   = "/codigo/db/faculdades.json"; // árvore de dados local
  ...
  form.addEventListener("submit", (e) => {
    e.preventDefault();
    const data = {
      name: $("#facul_nome").value.trim(),
      campus: $("#facul_campus").value.trim(),
      endereco: $("#facul_endereco").value.trim(),
      capa: $("#facul_capa").value.trim()
    };
